...
import static crypto.order.entity.order.OrderSide.BUY;
import static crypto.order.entity.order.OrderSide.SELL;
import static crypto.order.entity.order.OrderStatus.OPEN;
import static crypto.order.entity.order.OrderType.LIMIT;
import static crypto.order.entity.order.OrderType.MARKET;
