...
class OrderServiceTest {
    ...
    void createLimitBuyOrder() {
        ...
        // when
        Order order = orderService.createLimitBuyOrder(request, registeredDateTime);
    ...
    void deleteOrder() {
        ...
        // when
        orderService.deleteOrder(order.getId(), deletedDateTime);
    ...
    void deleteOrderWithNotExistOrder() {
        ...
        // when // then
        assertThatThrownBy(() -> orderService.deleteOrder(orderId, deletedDateTime))
